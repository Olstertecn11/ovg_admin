<?php
    ...
    if(!$mysqli){//comprobamos la conexión
        ...
        $ruta = "/home/smggt/public_html/publicaciones/files/".$fecha."";//barra se agrega despues de validar directorio
        ...
        if (($_FILES["file"]["type"] == "application/pdf")) {
            ...
            $evento = "Actualización de publicaciones";
            $descripcion = "El usuario $usuario de tipo $permiso ha actualizado la publicación ubicada en: $ruta con nombre de $nomArchi";
