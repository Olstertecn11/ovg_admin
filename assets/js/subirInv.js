            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data>0){
                        ...
                        alertify.confirm("ALERTA","Para la fecha seccionada ("+fecha+")"+" ya existe un archivo con el nombre "+nombreAlertify+" <br> ¿Desea actualizarlo?",
                            function(){
                                alertify.warning("Se actualizará el archivo");
                                //codigo de actualizacion
                                $("#subiendo").css("display","block");
                                $.ajax({
                                    url: 'php/actualizarInv.php',
                                    type: 'POST',
                                    data: datosDelForm,
                                    contentType: false,
                                    processData: false,
                        ...
                        $("#subiendo").css("display","block");
                        $.ajax({
                            url: 'php/subirInv.php',//archivo de php que recibira lso datos
                            type: 'POST',
                            data: datosDelForm,
                            contentType: false,
                            processData: false,
